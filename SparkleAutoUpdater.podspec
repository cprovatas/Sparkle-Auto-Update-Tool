#
#  Be sure to run `pod spec lint SparkleAutoUpdater.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "Easily autoupdate sparkle projects.  text...."
  ...
  s.author             = { "Charlton Provatas" => "charltonprovatas@gmail.com" }
  ...
  s.source_files  = "SparkleAutoUpdater/*.{swift}"
